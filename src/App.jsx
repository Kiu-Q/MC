                    ...
                    {weightSections.map((section, idx) => (
                        <div key={section.id} className="flex items-center gap-1 text-xs">
                            ...
                            {weightSections.length > 1 && (
                                <button onClick={() => setWeightSections(weightSections.filter(s => s.id !== section.id))} className="text-red-400 hover:text-red-600 bg-slate-50"><X className="w-3 h-3" /></button>
                            )}
                        </div>
                    ))}
                    <button onClick={() => {
